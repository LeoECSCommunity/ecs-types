...
namespace Leopotam.Ecs.Types {
    ...
    public struct CurveBezierQuad3 {
        ...
        public CurveBezierQuad3 (Float3 point0, Float3 point1, Float3 point2) {
            Point0 = point0;
            Point1 = point1;
            Point2 = point2;
        ...
        /// <param name="t">Position on curve, should be between 0 and 1.</param>
        public static Float3 GetVelocityAt (in Float3 point0, in Float3 point1, in Float3 point2, float t) {
        ...
        /// <param name="point1">Curve Point 1.</param>
        /// <param name="point2">Curve Point 2.</param>
        public static Float3 GetAcceleration (in Float3 point0, in Float3 point1, in Float3 point2) {
